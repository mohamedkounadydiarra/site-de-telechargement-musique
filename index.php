...
<small><i class="fa fa-phone-alt mr-2"></i>+223 77361700</small>
<small class="px-3">|</small>
<small><i class="fa fa-envelope mr-2"></i>youssouf1diakite1@gmail.com</small>
</div>
</div>
...
$req = $pdo->prepare("SELECT * FROM article ORDER BY idArticle DESC");
$req->execute();
