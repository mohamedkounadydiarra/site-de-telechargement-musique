...
<head>
<meta charset="utf-8">
<title>www.supreme communication.com</title>
...
<form action="search/rechercheSon.php" method="GET">
...
<h6 class="text-primary text-uppercase font-weight-bold">Comédie</h6>
<h5 class="mb-4">Nos comediens</h5>
</div>
<br>
<br>
<div class="row">
...
//la requette pour la liste des son
$req = $pdo->prepare(" SELECT idArticle,article.nom,description,datepublier,categorie.idCategorie,categorie.nom FROM article INNER JOIN categorie WHERE categorie.idCategorie = ?");
...
// $dislike = $dislikeListe->rowCount();

?>

<h6 style="color:white;"><?= $ett['nom']; ?></h6>
<a href="action/like.php?type=0&idArticle=<?= $ett['idArticle'] ?>"><img src="../img/like.png" width="35px" height="35px"><?= $like?></a>
<a href="action/like.php?type=1&idArticle=<?= $ett['idArticle'] ?>"><img src="../img/dislike.png" width="18px" height="18px"><?= $dislike?></a>
</div>
